	...
	<xsl:template name="Header">
		...
		<table cellpadding="0" cellspacing="0" border="0">
			<tr class="PageTitle">
				<td colspan="2">
					<a name="top">
					   ...
					   <xsl:text>Info2soft Client Automation Test Results</xsl:text>
			...
			<tbody class="PageTitleSmall">
				...
				<tr>
					<td>Browser:</td>	<td>Chrome 76.0.3809.132</td>							
				</tr>
				<tr>
					<td>OS:</td>
					<td>
							...
							<tbody class="LargeTableText">
										...
										<td class="InnerValueText">
											<a>
												<xsl:attribute name="href">
												   <xsl:value-of select="//test:report/test:build"/>/<xsl:value-of select="//test:report/test:suite/test:name"/>/<xsl:value-of select="..//test:component"/>/<xsl:value-of select="test:system-out/@href"/></xsl:attribute>
								...
								<!--<xsl:if test="test:qtp-out">-->
									<tr>
										...
										<td class="InnerValueText">
											<a>
												<xsl:attribute name="href">TestRunner.txt</xsl:attribute>
												<xsl:attribute name="target">_new</xsl:attribute>
												System Out
											</a></td>
									</tr>
								...
								<xsl:if test="test:screenshot">
									<tr>
										...
										<td class="InnerValueText">
											<a>
												<xsl:attribute name="href">
													<xsl:value-of select="//test:report/test:build"/>/<xsl:value-of select="//test:report/test:suite/test:name"/>/<xsl:value-of select="..//test:component"/>/<xsl:value-of select="test:screenshot/@href"/></xsl:attribute>
												<xsl:attribute name="target">_new</xsl:attribute>
												Screenshot
											</a></td>
									</tr>
